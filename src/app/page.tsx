  ...
  return (
    <div className="p-8 bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100 h-screen flex flex-col items-center text-center">
      <div className="max-w-[700px]">
        ...
        <button  className="bg-sky-500 px-4 py-2 rounded-md font-medium mt-4 dark:text-sky-950 dark:bg-sky-700 enabled:hover:bg-sky-600 disabled:opacity-60 disabled:cursor-not-allowed">Sign In</button>
      </div>
    </div> 
  )
}
